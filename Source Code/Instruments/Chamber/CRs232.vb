...
Public Class Rs232 : Implements IDisposable
    ...
    'Private COMP As System.IO.Ports.Parity
    '----------------------------------------------------------------------------------------

#Region "Enums"
    '// Parity Data
    Public Enum DataParity
        Parity_None = Ports.Parity.None
        Parity_Odd = Ports.Parity.Odd
        Parity_Even = Ports.Parity.Even
        Parity_Mark = Ports.Parity.Mark
        Parity_Space = Ports.Parity.Space
    End Enum
    '// StopBit Data
    Public Enum DataStopBit
        StopBit_None = Ports.StopBits.None
        StopBit_1 = Ports.StopBits.One
        StopBit_2 = Ports.StopBits.Two
        StopBit_1_5 = Ports.StopBits.OnePointFive
    End Enum
